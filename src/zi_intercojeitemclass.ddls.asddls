  ...
  //
{
  ...
  key Ledger,
      ...
      cast(substring(BestMatchClassificationRule, 1, instr(BestMatchClassificationRule, '-') - 1) as abap.dec(5,2))                                                                             as ClassificationRuleScore,
      cast( substring(BestMatchClassificationRule, instr(BestMatchClassificationRule, '-') + 1, length(BestMatchClassificationRule) - instr(BestMatchClassificationRule, '-')) as zint_rule_id) as ClassificationRuleExtID,
